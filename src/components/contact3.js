        ...
        <div className="contact3-section-title">
          ...
          <div className="contact3-content1">
            <h2 className="thq-heading-2">
              {props.heading1 ?? (
                <Fragment>
                  <span className="contact3-text19">Contact Us</span>
                </Fragment>
              )}
            </h2>
          ...
          <div className="contact3-content2">
            ...
            <div className="contact3-contact-info1">
                  ...
                  {props.content3 ?? (
                    <Fragment>
                      <span className="contact3-text24">
                        You can also fill out the form below to send us a
                        message.
                      </span>
                    </Fragment>
                  )}
              ...
              <span className="contact3-email thq-body-small">
                {props.email1 ?? (
                  <Fragment>
                    <span className="contact3-text25">contact@example.com</span>
                  </Fragment>
                )}
              </span>
            </div>
          ...
          <div className="contact3-content4">
            ...
            <div className="contact3-contact-info2">
              ...
              <span className="contact3-phone thq-body-small">
                {props.phone1 ?? (
                  <Fragment>
                    <span className="contact3-text26">+1234567890</span>
                  </Fragment>
                )}
              </span>
            </div>
