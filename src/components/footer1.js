              ...
              <div className="footer1-form">
                ...
                <button className="thq-button-outline footer1-button">
                  <span className="thq-body-small">
                    {props.action1 ?? (
                      <Fragment>
                        <span className="footer1-text13">/subscribe</span>
                      </Fragment>
                    )}
                  </span>
                </button>
          ...
          <div className="footer1-links">
            <div className="footer1-column1">
              <strong className="thq-body-large footer1-column1-title">
                {props.column1Title ?? (
                  <Fragment>
                    <span className="footer1-text28">Explore</span>
                  </Fragment>
                )}
              </strong>
              <div className="footer1-footer-links1">
                ...
                >
                  {props.link1 ?? (
                    <Fragment>
                      <span className="footer1-text25">About Us</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link2 ?? (
                    <Fragment>
                      <span className="footer1-text21">Services</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link4 ?? (
                    <Fragment>
                      <span className="footer1-text11">Facebook</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link5 ?? (
                    <Fragment>
                      <span className="footer1-text19">Twitter</span>
                    </Fragment>
                  )}
                </a>
              </div>
            ...
            <div className="footer1-column2">
              <strong className="thq-body-large footer1-column2-title">
                {props.column2Title ?? (
                  <Fragment>
                    <span className="footer1-text26">Connect</span>
                  </Fragment>
                )}
              </strong>
              <div className="footer1-footer-links2">
                ...
                >
                  {props.link6 ?? (
                    <Fragment>
                      <span className="footer1-text27">Instagram</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link7 ?? (
                    <Fragment>
                      <span className="footer1-text14">LinkedIn</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link8 ?? (
                    <Fragment>
                      <span className="footer1-text23">YouTube</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link9 ?? (
                    <Fragment>
                      <span className="footer1-text18">Pinterest</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link10 ?? (
                    <Fragment>
                      <span className="footer1-text12">Tumblr</span>
                    </Fragment>
                  )}
                </a>
              </div>
          ...
          <div className="footer1-row">
            ...
            <div className="footer1-footer-links3">
              ...
              <span className="thq-body-small">
                {props.cookiesLink ?? (
                  <Fragment>
                    <span className="footer1-text24">Cookie Policy</span>
                  </Fragment>
                )}
              </span>
            </div>
